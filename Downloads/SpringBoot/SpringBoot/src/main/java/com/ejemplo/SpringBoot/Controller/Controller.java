...
//Implementación Usuario
    @Autowired
    private IUsuarioService usurServ;
       
    @PostMapping("/new/usuario")
    public void agregarUsuario (@RequestBody Usuario usur) {
        usurServ.crearUsuario(usur);
    }
    
    @GetMapping("/ver/usuario")
    @ResponseBody
    public List<Usuario> verUsuario(){
        return usurServ.verUsuario();
    }
    
    //@DeleteMapping ("/delete/{id}")
    //public void borrarUsuario (@PathVariable Integer id){
    //    usurServ.borrarUsuario(id);
    //}
